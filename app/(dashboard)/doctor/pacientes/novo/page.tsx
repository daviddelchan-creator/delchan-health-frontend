  ...
  return (
    <Container size="md" py="xl">
      ...
      <Paper shadow="sm" radius="lg" p="xl" withBorder>
        ...
        <Text c="dimmed" mb="xl">Preencha as informações do paciente para integrá-lo ao prontuário eletrônico.</Text>
        
        {/* CORRECCIÓN: Propiedades exactas que exige el componente */}
        <DynamicIntakeForm 
          medplum={medplum}
          clinicType={"geral" as any}
          onSuccess={() => {
             // Redirige a la lista de pacientes una vez guardado
